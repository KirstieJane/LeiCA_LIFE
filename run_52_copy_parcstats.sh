...
export SUBJECTS_DIR="/data/liem-1/LIFE/freesurfer_all"

subjects_file='/scr/adenauer2/Franz/LIFE16/LIFE16_preprocessed_subjects_list_n2557.txt'
subjects_list=`cat ${subjects_file}`
out_base="/scr/adenauer2/Franz/LeiCA_LIFE/metrics"
