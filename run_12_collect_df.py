...
import pandas as pd
import numpy as np
from variables import metrics_root_path, subjects_list, subjects_list_folder
...
df = pd.DataFrame(columns=['mean_FD_P', 'max_FD_P', 'mean_FD_J', 'max_FD_J', 'n_TRs'])
FD_ts = None
...
for i, subject_id in enumerate(subjects_list):
    ...
    df.loc[subject_id] = (mean_FD_P, max_FD_P, mean_FD_J, max_FD_J, n_scans)
