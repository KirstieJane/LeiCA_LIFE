...
for training in ['training_life_only']:
    ds_root_path = os.path.join('/scr/adenauer2/Franz/LeiCA_LIFE/learning_out_predict_all_from_ncd_norm', training)
    working_dir = os.path.join('/data/liem-3/LeiCA_LIFE_learning_predict_all_from_ncd_norm_wd', training)
    trained_model_dir = os.path.join('/scr/adenauer2/Franz/LeiCA_LIFE/learning_out_ncd_norm', training)
