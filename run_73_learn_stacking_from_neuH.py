...
target = 'age'
# selection_crit = 'bothSexes_neuH_FD06_norm' #, 'bothSexes_neuH_FD06']
selection_crit_test = 'bothSexes_FD06'

# root_path_template = '/Users/franzliem/Dropbox/LeiCA/MS/in_data/learning_out_from_LIFE_models_20160429/{life_subjects_selection_crit}/pdfs/single_source_model_reg_{reg}_predicted'
# out_path_template = '/Users/franzliem/Dropbox/LeiCA/MS/in_data/learning_out_from_LIFE_models_20160429/{life_subjects_selection_crit}/stacking/stacking_out_reg_{reg}/'
# rf_root_template = '/Users/franzliem/Dropbox/LeiCA/MS/in_data/learning_out_20160429/stacking/stacking_out_reg_{reg}/'
